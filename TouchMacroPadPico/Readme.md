...
An i2c RGB Rotary Encoder can be plugged into the decoder using 4 wires with software support for coded functions and symbolic link file to macro actions in App folders.
