...
*Note that RP2040-based macropads (all using the Pico 1), are no longer updated - the Pico 1 does not have the required performance. The last PC-App that supports the Pico 1 is SerialPico75.* The current build PC-App-to-Pico-Firmware combination is: [**Serial2Pico75**](https://github.com/TobiasVanDyk/RPi-Pico1-Pico2-Applications/blob/main/TouchMacroPadPico/Serial2PicoApp/Serial2Pico74.zip), and the RP2350B FT6336 LCD **Pico2A4LCD.zip**, the Pico 2 LCD **VolumeMacroPad-Pico2-35IPS-339.zip**, the Pico 1 LCD **VolumeMacroPad-Pico1-35IPS-428**, and the Pico 1 GT911 LCD **Pico1Build.zip**. in their respective build folders: Capacitive-Touch-LCD, Pico2, and Pico1. *Note that you should use Serial2Pico76 with the RP2350B capacitive touch LCD and Serial2Pico75 with the resistive touch LCDs.*<br>   
