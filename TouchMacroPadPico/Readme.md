...
*Note that RP2040-based macropads (all using the Pico 1), are no longer updated - the Pico 1 does not have the required performance. The last PC-App that supports the Pico 1 is SerialPico74.* The current build PC-App-to-Pico-Firmware combination is: [**Serial2Pico75**](https://github.com/TobiasVanDyk/RPi-Pico1-Pico2-Applications/blob/main/TouchMacroPadPico/Serial2PicoApp/Serial2Pico74.zip), and the RP2350B LCD **Pico2A4LCD.zip** and the Pico 2 LCD **VolumeMacroPad-Pico2-35IPS-339.zip** in their respective build folders: Capacitive-Touch-LCD and Pico2.  
