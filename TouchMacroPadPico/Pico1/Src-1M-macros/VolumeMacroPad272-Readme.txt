...
Sketch uses 267496 bytes (25%) of program storage space. Maximum is 1044480 bytes.
Global variables use 63380 bytes (24%) of dynamic memory, leaving 198764 bytes for local variables. Maximum is 262144 bytes.
-------------------------------------------------------------------------------------------------------------------------------------------------
