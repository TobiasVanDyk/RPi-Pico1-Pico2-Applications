...
Sketch uses 256180 bytes (24%) of program storage space. Maximum is 1044480 bytes.
Global variables use 62636 bytes (23%) of dynamic memory, leaving 199508 bytes for local variables. Maximum is 262144 bytes.
Resetting COM9
