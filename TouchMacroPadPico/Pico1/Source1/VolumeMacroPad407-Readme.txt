...
"C:\\Users\\Tobias\\AppData\\Local\\Arduino15\\packages\\rp2040\\tools\\pqt-gcc\\4.1.0-1aec55e/bin/arm-none-eabi-size" -A "I:\\Data\\Win10\\Arduino/VolumeMacroPad407.ino.elf"
Sketch uses 251436 bytes (24%) of program storage space. Maximum is 1044480 bytes.
Global variables use 46552 bytes (17%) of dynamic memory, leaving 215592 bytes for local variables. Maximum is 262144 bytes.
Resetting COM9
Converting to uf2, output size: 563200, start address: 0x2000
Scanning for RP2040 devices
Flashing D: (RPI-RP2)
Wrote 563200 bytes to D:/NEW.UF2
----------------------------------------------------------------------------------------------------------------
...
New changes:
1. Fixed further Media *en* logic and expanded PC config
1. Added press keys M,S,T1-M,S,T24 on TouchLCD from PC with <kabcd> a=key1--6 b=LayerAD 0-3 c=Layout 1-4 d=delay (0 to 5 seconds for focus change if text string sent)
