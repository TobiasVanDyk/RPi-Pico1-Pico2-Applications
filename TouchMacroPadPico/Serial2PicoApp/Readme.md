...
*The usability of the App Switch feature is inversely related to its complexity. For best results, enable only two or three applications that benefit most from customized macros. Use the Application list in the Config tab to enable or disable apps, then save your changes. Alternatively, you can edit the apprules.json file directly.. Also remember that the application folder can also contain macrofiles, nKeys which are pointers to any file elsewhere in the system, and also macrolinks - a list of macros and instructions to be executed when pressing a macro key.* 
