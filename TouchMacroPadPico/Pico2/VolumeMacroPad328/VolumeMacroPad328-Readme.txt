...
"C:\\Users\\Tobias\\AppData\\Local\\Arduino15\\packages\\rp2040\\tools\\pqt-gcc\\4.1.0-1aec55e/bin/arm-none-eabi-size" -A "I:\\Data\\Win10\\Arduino/VolumeMacroPad328.ino.elf"
Sketch uses 243892 bytes (11%) of program storage space. Maximum is 2088960 bytes.
Global variables use 59208 bytes (11%) of dynamic memory, leaving 465080 bytes for local variables. Maximum is 524288 bytes.
C:\Users\Tobias\AppData\Local\Arduino15\packages\rp2040\tools\pqt-python3\1.0.1-base-3a57aed-1/python3 -I C:\Users\Tobias\AppData\Local\Arduino15\packages\rp2040\hardware\rp2040\5.5.0/tools/uf2conv.py --serial COM3 --family RP2040 --deploy I:\Data\Win10\Arduino/VolumeMacroPad328.ino.uf2 
Resetting COM3
Converting to uf2, output size: 565760, start address: 0x2000
Scanning for RP2040 devices
Flashing D: (RP2350)
Wrote 565760 bytes to D:/NEW.UF2
----------------------------------------------------------------------------------------------------------------
...
New changes:
1. *sx* Enables/disables direct File Save from files dragged and dropped into the PC App Comms Tab receive box where they are listed alphabetically and then sent one by 
   ...
   cannot be saved directly to Flash by design. 
