...
"C:\\Users\\Tobias\\AppData\\Local\\Arduino15\\packages\\rp2040\\tools\\pqt-gcc\\4.1.0-1aec55e/bin/arm-none-eabi-size" -A "I:\\Data\\Win10\\Arduino/VolumeMacroPad322.ino.elf"
Sketch uses 241820 bytes (11%) of program storage space. Maximum is 2088960 bytes.
Global variables use 47288 bytes (9%) of dynamic memory, leaving 477000 bytes for local variables. Maximum is 524288 bytes.
----------------------------------------------------------------------------------------------------------------
...
New changes:
1. Fixed furher Media *en* logic and expanded config to PC
2. Added press keys M,S,T1-M,S,T24 on TouchLCD from PC with <kabcd> a=key1--6 b=LayerAD 0-3 c=Layout 1-4 d=delay (0 to 5 seconds for focus change if text string sent). Note that if LCD is dimmed it
