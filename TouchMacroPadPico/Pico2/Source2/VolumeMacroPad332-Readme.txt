...
Sketch uses 246812 bytes (11%) of program storage space. Maximum is 2088960 bytes.
Global variables use 63420 bytes (12%) of dynamic memory, leaving 460868 bytes for local variables. Maximum is 524288 bytes.
...
Resetting COM3
Converting to uf2, output size: 571904, start address: 0x2000
Scanning for RP2040 devices
Flashing D: (RP2350)
Wrote 571904 bytes to D:/NEW.UF2
----------------------------------------------------------------------------------------------------------------
...
New changes:
1. Started fixing Time and Clock code for Pico 2 which lacks an RTC and requires additional code. Power Timers Clock-Restart and Clock-PowerOff now working.
