...
Sketch uses 249156 bytes (11%) of program storage space. Maximum is 2088960 bytes.
...
Resetting COM3
Converting to uf2, output size: 576512, start address: 0x2000
Scanning for RP2040 devices
Flashing D: (RP2350)
Wrote 576512 bytes to D:/NEW.UF2
----------------------------------------------------------------------------------------------------------------
...
New changes:
1. Various fixes to <1 - <6 handling, *up*0,1 off/on Macro Upper/Lower case added, SDCardNum Pad [n] + Pad[o] used, SDCardArr[2] sent to PC App, changes to [Cfg][Sav] such as A-D only saved from [A-D] not L1,L3,L4 changes.
