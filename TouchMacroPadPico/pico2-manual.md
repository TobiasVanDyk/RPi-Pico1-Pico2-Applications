...
and when changed on the PC App via *1s,e*char remember to change the start char to the newly changed one when send the
*command to change the end character.
