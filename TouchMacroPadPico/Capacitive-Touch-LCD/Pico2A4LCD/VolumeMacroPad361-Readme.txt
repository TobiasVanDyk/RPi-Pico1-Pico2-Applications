...
Sketch uses 293832 bytes (3%) of program storage space. Maximum is 8380416 bytes.
...
Flashing D: (RP2350)
Wrote 670208 bytes to D:/NEW.UF2
----------------------------------------------------------------------------------------------------------------
...
New changes: (All changes from 5 below were in the last GT911 capacive touch version)
1. Added Twists connected to PC App
2. Slight tweaking of FT6336 init routines
3. Fixed 2nd and 3rd Twist not changing colour when turned
4. Fixed Key Repeat and KeyHeld Vol Mute change - reverted to previous code.
...
11. Added Key Threshold *ke*nnn nnn = 100-999 Use *kh* for Key Hold enable if VolMute.
12. Added Rotary Encoder plugin with support for coded functions and symbolic link to macro actions in App folders and example Files4Twist.zip
