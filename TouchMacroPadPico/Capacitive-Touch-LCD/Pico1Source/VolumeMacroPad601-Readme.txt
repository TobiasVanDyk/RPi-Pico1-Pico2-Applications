...
Sketch uses 289968 bytes (27%) of program storage space. Maximum is 1044480 bytes.
Global variables use 66692 bytes (25%) of dynamic memory, leaving 195452 bytes for local variables. Maximum is 262144 bytes.
Resetting COM14
Converting to uf2, output size: 658432, start address: 0x2000
Scanning for RP2040 devices
Flashing E: (RPI-RP2)
Wrote 658432 bytes to E:/NEW.UF2
----------------------------------------------------------------------------------------------------------------
...
New changes:
1. Added up to 10 Sparkfun Twist Encoder i2c devices - default is 2 but change #define twX 2 to the required number 0-9 of twistDevices.
...
2. Added MCP23008,MCP23017,MCP23018 0-8 devices on i2c bus. Can read inputs then run either linked seequence of macros or single macro, and set 
...
5. ILI9488 and GT911 LCD and Touch display 
