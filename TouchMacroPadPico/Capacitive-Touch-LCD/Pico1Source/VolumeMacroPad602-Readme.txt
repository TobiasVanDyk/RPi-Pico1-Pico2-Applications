...
Sketch uses 303384 bytes (29%) of program storage space. Maximum is 1044480 bytes.
Global variables use 71280 bytes (27%) of dynamic memory, leaving 190864 bytes for local variables. Maximum is 262144 bytes.
Resetting COM14
...
2. Fixed Key Repeat and KeyHeld Vol Mute change - reverted to previous code.
3. Fixed missed Twist device 0 and limited scanning for Twists devices to actaul connected devices
...
9. ILI9488 and GT911 LCD and Touch display 
