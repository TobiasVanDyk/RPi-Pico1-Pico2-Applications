...
Pico 2 RP2350 and DFRobot DFR0669 3.5inch Capacitve Touch Display Module with ILI9488 and GT911
-------------------------------------------------------------------------------------------------------------------------------------------------
...
Sketch uses 276344 bytes (13%) of program storage space. Maximum is 2088960 bytes.
Global variables use 67092 bytes (12%) of dynamic memory, leaving 457196 bytes for local variables. Maximum is 524288 bytes.
----------------------------------------------------------------------------------------------------------------
...
NB: Use 4MB Flash option with 2MB Sketch 2MB FS 
    ...
    (2) #define TFT_INVERSION_ON       

    Used here:  #define SPI_FREQUENCY       12000000   // lower frequency needed for Pico 2
...
3. ILI9488 and GT911 LCD and Touch display 
