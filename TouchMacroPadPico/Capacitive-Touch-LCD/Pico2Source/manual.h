...
-----------------------------------------------------------------------------------------------------------------------
Layout 2A - Config - Cycle through Layout 1 to 4 press [L1-L4] or [Vo] if Mute is the current option for [L2]
-----------------------------------------------------------------------------------------------------------------------
...
[o] Red Options Pad:  Config Mode - Toggle Capslock and Numlock on/off in combinations
    Green Colour ->   Macro Mode  - 4-Cycle combinations of Source and Destination SDCard (Orange) or Flash (White) 
                      ...
                      [Opt] Mode  - Macro Upper/Lower case files, KeyRepeat Time, StartupLayout L1-L4,
...
-----------------------------------------------------------------------------------------------------------------------
To cycle through the Layouts press [L1-L4]. Also use the three Pads [m][s][t] to move to Layers L1 L3 L4 and use 
the top or bottom pads [a][d] to move through the four layers a,b,c,d.
...
[Opt] [Home      ] - Repeat Keyheld Time, Select Startup Layout L1-L4,
...
(w) Key Held Enable: *ke*nn Key held repeat time in 10 x mS
