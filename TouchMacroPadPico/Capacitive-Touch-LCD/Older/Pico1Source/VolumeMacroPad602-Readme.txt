...
"C:\\Users\\Tobias\\AppData\\Local\\Arduino15\\packages\\rp2040\\tools\\pqt-gcc\\4.1.0-1aec55e/bin/arm-none-eabi-size" -A "I:\\Data\\Win10\\Arduino/VolumeMacroPad602.ino.elf"
Sketch uses 303856 bytes (29%) of program storage space. Maximum is 1044480 bytes.
Global variables use 71348 bytes (27%) of dynamic memory, leaving 190796 bytes for local variables. Maximum is 262144 bytes.
Resetting COM14
Converting to uf2, output size: 687616, start address: 0x2000
Scanning for RP2040 devices
Flashing E: (RPI-RP2)
Wrote 687616 bytes to E:/NEW.UF2
----------------------------------------------------------------------------------------------------------------
...
4. New Key Repeat and KeyHeld Vol Mute change - [*Cm] repeat still not ok for GT911 (ok for FT6336)
5. Fixed missed Twist device 0 and limited scanning for Twists devices to actaul connected devices
6. Changed option x to repeat the last key pressed when Twist is turned - it is a very useful option. Whether the [S1] is pressed that types a text string, 
...
7. Added up to 7 Sparkfun Twist Encoder i2c devices - default is 2 but change #define twX 2 to the required number 0-7 of twistDevices.
...
8. Added MCP23008,MCP23017,MCP23018 0-8 devices on i2c bus. Can read inputs then run either linked seequence of macros or single macro, and set outputs
   using star codes. Can toggle inputs and outputs on the PC App. See manual section (Ab) for details.
9. CircuitPython device control and used as input and/or output for Pico macropad and/or PC App. 
...
10. Rotary Encoder long-press for "Twist Options d-Z Ready" shows. Then turn encoder for the options vuzsxdwbVUZSXDWB. Long-press Twist again
...
11. ILI9488 and GT911 LCD and Touch display 
